  ...
  return (
    <main className="bg-white text-slate-800">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="max-w-2xl text-white">
              ...
              <p className="mt-6 max-w-xl text-base leading-7 text-red-50 sm:text-lg">
                Every blood donation is a gift of life. Join Start Moscow Blood
        ...
        <div className="mx-auto grid max-w-7xl items-center justify-items-center gap-12 px-4 py-20 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl">
            ...
            <p className="mt-5 text-base leading-7 text-slate-600">
              ...
              life-saving network across the country and one day connect donors
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-4xl bg-linear-to-r from-red-600 via-red-700 to-red-900 px-6 py-14 text-white shadow-2xl sm:px-10">
          {/* Heading */}
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-red-100 sm:text-base">
              Urgent blood support? Our emergency team is available to help you
              connect with donors quickly when every second matters.
            </p>
          </div>
