...
//                         className="flex aspect-square items-center justify-center rounded-xl bg-green-50 text-green-700 ring-1 ring-green-100 transition hover:bg-green-100"
//                       >
...
//                         className="flex aspect-square items-center justify-center rounded-xl bg-red-600 text-white transition hover:bg-red-700"
//                       >
//                         <FaPhoneAlt className="h-5 w-5 sm:h-6 sm:w-6 md:h-7 md:w-7" />
//                       </a>

//                       <Link
//                         to={`/singledonor/${donor._id}`}
//                         aria-label="View donor details"
//                         className="flex aspect-square items-center justify-center rounded-xl bg-red-50 text-red-700 ring-1 ring-red-100 transition hover:bg-red-100"
//                       >
...
import { useDispatch, useSelector } from "react-redux";
import { Link } from "react-router-dom";
import { Search, Droplets, RotateCcw, MapPin, Users } from "lucide-react";
import { FaWhatsapp, FaPhoneAlt, FaInfoCircle } from "react-icons/fa";
